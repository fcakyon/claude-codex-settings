...
- A project you've already created in Openship (if not, start with [Deploy from GitHub](https://openship.io/docs/guides/deploy-from-github)).
...
<Callout title="Screenshot">
  Project → **Configuration** tab, the "Environment variables" card with its **Edit** button.
  *(screenshot pending)*
</Callout>
...
<Callout title="Screenshot">
  The env editor after saving, showing the "Apply without a rebuild" notice and the **Apply
  (restart, no rebuild)** button. *(screenshot pending)*
</Callout>
...
<Callout title="The build failed with a missing-variable error" type="error">
  ...
  then deploy again. See [Troubleshooting → Deployments](https://openship.io/docs/troubleshooting/deployments) for
  more.
</Callout>
...
<Cards>
  ...
  <Card
    ...
    href="https://openship.io/docs/guides/custom-domains"
    description="Put your app on your own address with automatic HTTPS."
  />
  <Card
    title="Multi-service apps"
    href="https://openship.io/docs/guides/compose-multi-service"
