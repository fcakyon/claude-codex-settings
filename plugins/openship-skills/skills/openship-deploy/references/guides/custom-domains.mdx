...
- A project already deployed in Openship (see [Your first deployment](https://openship.io/docs/getting-started/first-deployment)).
...
[Domains API reference](https://openship.io/docs/api/domains).
</Callout>
...
<Cards>
  <Card title="Domains API reference" href="https://openship.io/docs/api/domains" description="Every domain endpoint — add, preview, verify, primary, and SSL — with request shapes." />
  <Card title="Deploy from GitHub" href="https://openship.io/docs/guides/deploy-from-github" description="The full flow for getting a repo online, if you haven't yet." />
  <Card title="Environment variables" href="https://openship.io/docs/guides/environment-variables" description="Give your app its secrets and settings, safely." />
</Cards>
