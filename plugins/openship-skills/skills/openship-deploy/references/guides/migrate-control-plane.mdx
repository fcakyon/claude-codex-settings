...
Install and start Openship on the server first (see [Installation](https://openship.io/docs/getting-started/installation)),
then:
...
- [Deploy a local folder](https://openship.io/docs/guides/deploy-local-folder) — the no-git deploy this guide re-points to.
- [Server-to-server migration](https://openship.io/docs/guides/server-to-server-migration) — moving a *running app + its
  volumes* between servers (different from moving the control plane).
- [Database migrations](https://openship.io/docs/guides/database-migrations) — backing up and migrating a stateful volume
