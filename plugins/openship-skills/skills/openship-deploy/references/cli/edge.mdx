...
domain, protecting a route, watching traffic — start with the [The edge](https://openship.io/docs/guides/the-edge) guide.
</Callout>
...
[Running & updating](https://openship.io/docs/cli/run)); the **edge** is the public reverse proxy in front of your
...
[context](https://openship.io/docs/cli/access) points at.
</Callout>
...
[`openship domain`](https://openship.io/docs/cli/projects) command — `edge domains` is the edge-scoped view of the same
routing.
...
you must run with `--trust-proxy` — see [`openship up`](https://openship.io/docs/cli/run). Openship's own managed edge
...
logs — is on the dashboard's Overview and Logs tabs: see [Logs & monitoring](https://openship.io/docs/guides/logs-monitoring).
</Callout>

## Where to next

<Cards>
  <Card title="Running & updating" href="https://openship.io/docs/cli/run" description="up, stop, update — install the server the edge reports into." />
  <Card title="Projects, services & domains" href="https://openship.io/docs/cli/projects" description="init, project, service, and the full domain workflow." />
  <Card title="Logs & monitoring" href="https://openship.io/docs/guides/logs-monitoring" description="The dashboard view of the same traffic, request logs, and analytics." />
</Cards>
