...
They're the terminal equivalent of the dashboard's [Servers](https://openship.io/docs/dashboard/servers),
[Settings](https://openship.io/docs/dashboard/settings), [Emails](https://openship.io/docs/dashboard/emails), and
[Backups](https://openship.io/docs/dashboard/backups) screens.
...
[Custom servers guide](https://openship.io/docs/guides/custom-servers) for the click-by-click version.
...
[Cloud connect & migration](https://openship.io/docs/guides/cloud-connect-migration).
...
`--confirm I-understand-no-auth`. See [Authentication](https://openship.io/docs/security/auth) for what each mode means.
</Callout>
...
[Emails](https://openship.io/docs/dashboard/emails) screen; the [Email & webmail guide](https://openship.io/docs/guides/email-webmail) walks
...
[Backups](https://openship.io/docs/dashboard/backups) screen; the [Backups & restore guide](https://openship.io/docs/guides/backups-restore)
covers the concepts.
...
<Cards>
  <Card title="Custom servers" href="https://openship.io/docs/guides/custom-servers" description="Connect and prepare your own machines to deploy on." />
  <Card title="Cloud connect & migration" href="https://openship.io/docs/guides/cloud-connect-migration" description="Move an instance between self-hosted, cloud, and tunnel modes." />
  <Card title="Email & webmail" href="https://openship.io/docs/guides/email-webmail" description="Stand up the self-hosted mail server end to end." />
  <Card title="Backups & restore" href="https://openship.io/docs/guides/backups-restore" description="Schedule backups and restore from a run." />
</Cards>
