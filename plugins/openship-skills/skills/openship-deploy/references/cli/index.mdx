...
[Installation](https://openship.io/docs/getting-started/installation) — the short version is `npm i -g openship`
...
only once. (You can also mint tokens from the CLI with [`openship token create`](https://openship.io/docs/cli/access).)
...
### Running & updating — [reference](https://openship.io/docs/cli/run)
...
### Access & the raw API — [reference](https://openship.io/docs/cli/access)
...
### Deploying — [reference](https://openship.io/docs/cli/deploy)
...
### Projects, services & domains — [reference](https://openship.io/docs/cli/projects)
...
### Edge & monitoring — [reference](https://openship.io/docs/cli/edge)
...
### Self-host infrastructure — [reference](https://openship.io/docs/cli/self-host)
...
<Cards>
  <Card title="Running & updating" href="https://openship.io/docs/cli/run" description="up, stop, update, install — operate Openship itself." />
  <Card title="Deploying" href="https://openship.io/docs/cli/deploy" description="deploy, deployment, logs — the full deploy loop." />
  <Card title="Projects, services & domains" href="https://openship.io/docs/cli/projects" description="init, project, service, and domain commands." />
  <Card title="Edge & monitoring" href="https://openship.io/docs/cli/edge" description="The :80/:443 proxy, proxy take-over, rules, and traffic analytics." />
  <Card title="Access & the raw API" href="https://openship.io/docs/cli/access" description="login, context, token, api — auth and any route." />
  <Card title="Self-host infrastructure" href="https://openship.io/docs/cli/self-host" description="server, system, mail, and backup for instances you run." />
</Cards>
