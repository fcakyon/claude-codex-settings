...
Browse the [API reference](https://openship.io/docs/api) for paths, methods, and required permissions. The resource commands
([`project`, `service`, `domain`, and friends](https://openship.io/docs/cli/projects)) wrap the common ones in a friendlier
